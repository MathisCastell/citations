            ...
            <div class="col-12 col-md-10">
                ...
                <div class="card-deck">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="card-text">"La peinture est une poésie qui se voit au lieu de se sentir et la poésie est une peinture qui se sent au lieu de se voir." - Léonard de Vinci1</p>
                        </div>
                    </div>
                    <div class="card">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="card-text">"L'art est le plus beau des mensonges." - Claude Debussy</p>
                        </div>
                    </div>
                </div>
            </div>
